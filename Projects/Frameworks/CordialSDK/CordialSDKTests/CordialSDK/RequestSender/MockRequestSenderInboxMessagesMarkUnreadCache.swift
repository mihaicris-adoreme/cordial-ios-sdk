//
//  MockRequestSenderInboxMessagesMarkUnreadCache.swift
//  CordialSDKTests
//
//  Created by Yan Malinovsky on 20.12.2020.
...
class MockRequestSenderInboxMessagesMarkUnreadCache: RequestSender {
    ...
    override func sendRequest(task: URLSessionDownloadTask) {
        ...
        if let inboxMessagesMarkReadUnreadURL = self.sdkTests.testCase.getInboxMessagesMarkReadUnreadURL(),
           ...
           let markAsReadIds = json["markAsUnReadIds"] as? [String],
