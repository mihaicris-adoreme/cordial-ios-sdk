...
- (void)registerForPushNotificationsWithOptions:(UNAuthorizationOptions)options completionHandler:(void (^ _Nonnull)(BOOL, NSError * _Nullable))completionHandler;
...
- (void)initializeWithAccountKey:(NSString * _Nonnull)accountKey channelKey:(NSString * _Nonnull)channelKey SWIFT_AVAILABILITY(ios,deprecated=0.0.1,message="Use initialize(accountKey:channelKey:eventsStreamURL:messageHubURL) instead");
