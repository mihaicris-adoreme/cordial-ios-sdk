...
struct API {
    ...
    static let USER_DEFAULTS_KEY_FOR_BASE_URL = "USER_DEFAULTS_KEY_FOR_BASE_URL"
    ...
    static let DOWNLOAD_TASK_NAME_FETCH_INBOX_MESSAGES = "DOWNLOAD_TASK_NAME_FETCH_INBOX_MESSAGES"
