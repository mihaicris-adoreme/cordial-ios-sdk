...
struct API {
    ...
    static let EVENT_NAME_PUSH_NOTIFICATION_APP_OPEN_VIA_TAP = "\(API.SYSTEM_EVENT_PREFIX)app_open_via_notification_tap"
    static let EVENT_NAME_DEEP_LINKS_APP_OPEN_VIA_DEEP_LINK = "\(API.SYSTEM_EVENT_PREFIX)app_open_via_deep_link"
