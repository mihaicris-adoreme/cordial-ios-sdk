...
To activate this feature, it would be sufficient to create a new list of notification settings with the different available categories and their corresponding configuration options:
...
___
```
CordialApiConfiguration.shared.pushNotificationSettingsDelegate = YourNotificationSettingsHandler()
```
&nbsp;&nbsp;&nbsp;&nbsp;Objective-C:
___
```
